...
DOCS = [('1','rde_factura.xml'),('4','rde_factura.xml'),('5','rde_factura.xml'),('6','rde_factura.xml'),('7','rde_remision.xml')]
CODSEG = "123456789"
...
def main():
    ...
    with webapp.app.app_context():
        ...
        for doc_type, tpl in DOCS:
            ...
            lines = [{'description':'L1','qty':Decimal('1.0'),'price_unit':Decimal('100'),'line_total':Decimal('100'),'iva_rate':10}]
